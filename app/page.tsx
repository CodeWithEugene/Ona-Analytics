        ...
        <div className="max-w-7xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-1000">
          <div className="grid lg:grid-cols-12 gap-12 items-center mb-16">
            ...
            <div className="lg:col-span-7">
              <FadeIn>
                ...
                <div className="flex flex-wrap items-center gap-5">
                  ...
                  <a 
                    href="#problem" 
                    className="inline-flex items-center gap-1.5 text-sm font-semibold text-foreground/50 hover:text-foreground transition-colors py-2 px-4"
                  >
            ...
            <div className="lg:col-span-5 w-full">
              <FadeIn delay={200}>
                <div className="rounded-[2.5rem] p-1.5 bg-foreground/5 ring-1 ring-foreground/5 shadow-xl">
                  <div className="bg-[#0A0A0A] rounded-[calc(2.5rem-0.375rem)] shadow-2xl p-6 border border-white/[0.04] text-white">
                    ...
                    <div className="space-y-4">
                      {/* Transit Operations */}
                      <div>
                        <span className="text-[9px] font-mono text-white/30 uppercase tracking-widest block mb-2">Transit Operations</span>
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center justify-between p-2.5 rounded-lg bg-white/[0.02] border border-white/[0.04]">
                            <div className="flex items-center gap-2.5">
                              ...
                              <div>
                                <div className="text-xs font-semibold text-white/90">Truck B (Propane Cylinders)</div>
                                <span className="text-[10px] text-white/40 block">Awaiting dispatch confirmation</span>
                              </div>
                            </div>
                            <span className="text-[10px] bg-amber-500/10 text-amber-500 border border-amber-500/20 px-2 py-0.5 rounded font-mono">Standby</span>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Contingency Monitor */}
                      <div>
                        <span className="text-[9px] font-mono text-white/30 uppercase tracking-widest block mb-2">Contingency Monitor</span>
                        <div className="grid grid-cols-2 gap-2">
                          ...
                          <div className="p-2.5 rounded-lg bg-primary/5 border border-primary/15">
                            ...
                            <span className="text-[10px] text-white/50 leading-tight block">Kitchen fresh produce down to 22%.</span>
                          </div>
                        </div>
                      </div>
                          ...
                          {[
                            ...
                            <div key={idx} className="space-y-1">
                              <div className="flex justify-between text-[10px]">
                                <span className="text-white/60">{gauge.name}</span>
                                <span className="font-mono text-white/40">{gauge.val}%</span>
                              </div>
              ...
              <div className="rounded-[calc(2rem-0.375rem)] bg-[#0A0A0A] overflow-hidden text-white border border-white/[0.04]">
                ...
                <div className="grid lg:grid-cols-12 gap-0">
                  ...
                  <div className="lg:col-span-5 border-b lg:border-b-0 lg:border-r border-white/[0.04] p-6 bg-[#0E0E0E] flex flex-col justify-between min-h-[380px]">
                      ...
                      <div className="space-y-4">
                        ...
                        {simStep >= 1 && (
                          <div className="p-3 rounded-lg bg-white/[0.02] border border-white/[0.04] animate-in fade-in duration-300">
                            ...
                            <div className="text-[10px] text-emerald-400 font-mono mt-1">&gt; Found surge: +54.1% occupancy predicted.</div>
                          </div>
                        )}
                    ...
                    <div className="pt-4 border-t border-white/[0.03] text-xs text-white/30 font-mono flex items-center justify-between">
                  ...
                  <div className="lg:col-span-7 p-6 md:p-8 flex flex-col justify-between">
                    <div>
                      ...
                      {/* Bar Graph */}
                      <div className="h-44 flex items-end gap-2.5 border-b border-white/[0.05] pb-2">
                    ...
                    <div className="mt-8 pt-6 border-t border-white/[0.04] grid grid-cols-1 sm:grid-cols-3 gap-4">
                      ...
                      <div className="p-3.5 rounded-xl bg-white/[0.02] border border-white/[0.04]">
                        <span className="text-[10px] text-white/30 font-mono block mb-1">Weekly Delta</span>
                        <span className="text-xl font-bold text-emerald-400">+54.0%</span>
                        <span className="text-[9px] text-white/25 block mt-0.5">vs prior avg</span>
                      </div>
                      <div className="p-3.5 rounded-xl bg-white/[0.02] border border-white/[0.04]">
      ...
      <section id="problem" className="py-24 md:py-32 px-6 bg-slate-900 text-slate-100 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            {/* Left Column: Interactive leather notebook timeline */}
            <div className="lg:col-span-6">
              <FadeIn delay={150}>
                        ...
                        <div key={idx} className="flex gap-6 relative group">
                          ...
                          <div>
                            <div className="flex items-baseline gap-2 mb-1">
                              ...
                              <span className="text-[9px] font-mono text-white/30">({step.day})</span>
                            </div>
