...
import { ArrowUpRight, TrendingUp, Eye, Package, Radio } from "lucide-react"
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FBF8F4] text-[#1C1816] overflow-x-hidden">
      <a href="#main" className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-[#1C1816] focus:text-[#FBF8F4] focus:rounded-full focus:text-sm">
        Skip to content
      </a>
      ...
      <nav aria-label="Primary" className={`fixed top-0 left-0 right-0 z-40 transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] ${scrolled ? 'bg-[#FBF8F4]/80 backdrop-blur-2xl shadow-[0_1px_0_rgba(28,24,22,0.06)]' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/" className="text-xl font-display italic tracking-tight" aria-label="Ona Analytics home">
            Ona
          </Link>
          <div className="hidden md:flex items-center gap-10">
            <button onClick={() => scrollTo("features")} className="text-sm font-medium text-[#1C1816]/70 hover:text-[#1C1816] transition-colors duration-300">
              Features
            </button>
            <button onClick={() => scrollTo("how-it-works")} className="text-sm font-medium text-[#1C1816]/70 hover:text-[#1C1816] transition-colors duration-300">
              How it works
            </button>
            <Link href="/login" className="text-sm font-medium text-[#1C1816]/70 hover:text-[#1C1816] transition-colors duration-300">
              Sign in
            </Link>
            <Link
              href="/login"
      ...
      <div className={`fixed inset-0 z-30 bg-[#FBF8F4]/95 backdrop-blur-3xl transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] ${menuOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
        <nav aria-label="Mobile" className="flex flex-col items-center justify-center h-full gap-8">
          <button onClick={() => { scrollTo("features"); closeMenu() }} className="text-2xl font-display">Features</button>
          <button onClick={() => { scrollTo("how-it-works"); closeMenu() }} className="text-2xl font-display">How it works</button>
          <Link href="/login" onClick={closeMenu} className="text-2xl font-display">Sign in</Link>
          <Link href="/login" onClick={closeMenu} className="inline-flex items-center gap-2 rounded-full bg-[#1C1816] px-6 py-3 text-sm font-medium text-[#FBF8F4]">
            Explore dashboard
      ...
      <main id="main">
        <section className="relative min-h-[100dvh] flex items-center pt-24 md:pt-0">
          ...
          <div className="max-w-7xl mx-auto px-6 w-full">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 rounded-full border border-[#1C1816]/10 bg-[#1C1816]/5 px-4 py-1.5 text-[11px] uppercase tracking-[0.15em] font-medium text-[#1C1816]/70">
                AI-Native Demand Intelligence
              </div>
              <h1 className="mt-8 text-[clamp(2.5rem,8vw,6.5rem)] font-display italic leading-[1.05] tracking-tight text-[#1C1816]">
                See what&apos;s
                <br />
              ...
              <p className="mt-6 max-w-lg text-base md:text-lg leading-relaxed text-[#1C1816]/70">
                Predictive demand radar for remote safari camps and eco-lodges. 
                AI-powered forecasting that turns uncertainty into foresight &mdash;
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
              <div className="space-y-6">
                <h2 className="text-[clamp(1.75rem,4vw,3.5rem)] font-display italic leading-[1.1] tracking-tight">
                  The blind spot
                  <br />
                  <span className="not-italic">in camp operations</span>
                </h2>
                <p className="text-base leading-relaxed text-[#1C1816]/70">
                  ...
                  feelings. One unexpected booking surge &mdash; one delayed truck &mdash; and 
                    ...
                    <div className="space-y-6">
                      {[
                        ...
                        <div key={i} className="flex items-center justify-between py-3 border-b border-[#1C1816]/5 last:border-0">
                          <span className="text-sm text-[#1C1816]/70">{stat.label}</span>
        ...
        {/* Features Bento Grid */}
        <section id="features" className="py-32 md:py-44 bg-[#1C1816] text-[#FBF8F4]">
          <div className="max-w-7xl mx-auto px-6">
            <div className="max-w-2xl mb-20">
              <div className="inline-flex items-center gap-2 rounded-full border border-[#FBF8F4]/10 bg-[#FBF8F4]/5 px-4 py-1.5 text-[11px] uppercase tracking-[0.15em] font-medium text-[#FBF8F4]/70">
                The Ona Platform
              </div>
              <h2 className="mt-6 text-[clamp(1.75rem,4vw,3.5rem)] font-display italic leading-[1.1] tracking-tight">
                Intelligence that
                <br />
            ...
            <div className="grid md:grid-cols-12 gap-4">
              ...
              <div className="md:col-span-5 p-1.5 rounded-[2rem] bg-[#FBF8F4]/5 ring-1 ring-[#FBF8F4]/5">
                <div className="rounded-[calc(2rem-0.375rem)] bg-[#1C1816] p-8 md:p-10 h-full">
                  ...
                  <p className="text-sm leading-relaxed text-[#FBF8F4]/70">
              ...
              <div className="md:col-span-7 p-1.5 rounded-[2rem] bg-[#FBF8F4]/5 ring-1 ring-[#FBF8F4]/5">
                <div className="rounded-[calc(2rem-0.375rem)] bg-[#1C1816] p-8 md:p-10 h-full">
                  ...
                  <p className="text-sm leading-relaxed text-[#FBF8F4]/70">
                    Powered by NVIDIA Nemotron. The model learns your camp&apos;s seasonal trends, 
                    weather correlations, and booking behaviors.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="how-it-works" className="py-32 md:py-44">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-20">
              ...
              <h2 className="mt-6 text-[clamp(1.75rem,4vw,3rem)] font-display italic leading-[1.1] tracking-tight">
                Connect. Forecast.
                <br />
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-12">
              {[
                ...
                <div key={i}>
                  <div className="text-[4rem] md:text-[5rem] font-display italic leading-none text-[#D4A853]/20">
                    {s.step}
                  </div>
                  <h3 className="mt-4 text-xl font-display italic">{s.title}</h3>
                  <p className="mt-3 text-sm leading-relaxed text-[#1C1816]/70">{s.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* CTA */}
        <section id="cta" className="py-32 md:py-44 bg-[#1C1816] text-[#FBF8F4]">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-[clamp(1.75rem,4vw,3.5rem)] font-display italic leading-[1.1] tracking-tight">
              Ready to see what&apos;s coming?
            </h2>
            <p className="mt-6 text-base leading-relaxed text-[#FBF8F4]/70 max-w-md mx-auto">
              Ona Analytics is currently in private beta with select camps across East Africa. 
              Sign in to explore the live dashboard.
            </p>
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              ...
              <Link
                href="/login"
                className="inline-flex items-center gap-2 rounded-full border border-[#FBF8F4]/15 bg-transparent px-7 py-3.5 text-sm font-medium text-[#FBF8F4]/70 transition-all duration-300 hover:border-[#FBF8F4]/30 hover:text-[#FBF8F4] active:scale-[0.97]"
              >
                Sign in
              </Link>
            </div>
      ...
      <footer className="py-16 border-t border-[#1C1816]/5">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <Link href="/" className="text-sm font-display italic tracking-tight text-[#1C1816]/40" aria-label="Ona Analytics home">
            Ona Analytics
          </Link>
          <div className="flex items-center gap-6">
            <span className="text-xs text-[#1C1816]/30">&copy; 2026 Ona Analytics.</span>
          </div>
        </div>
      </footer>
    </div>
